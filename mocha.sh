...
NODE_ENV=development gulp init
NODE_ENV=test mocha --reporter spec --colors --timeout 100000 --require lib/mongoose --require should --require co --require co-mocha --require cls --recursive --ui bdd -d $*
